...
return [
    ...
    'description' => 'RESTful API for the Dental Clinic Management System. Provides endpoints for managing patients, appointments, treatments, billing, and clinic operations.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
        Welcome to the Dental Clinic API documentation.

        ## Authentication
        This API uses Laravel Sanctum for authentication. Most endpoints require a valid Bearer token.

        ## Response Format
        All responses follow a consistent JSON structure:
        - **Success responses**: `{ "success": true, "message": "...", "data": {...}, "meta": {...} }`
        - **Error responses**: `{ "success": false, "message": "...", "error_code": "...", "meta": {...} }`
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate using Laravel Sanctum. Obtain a token via the `/api/v1/auth/login` endpoint.',
    ],
